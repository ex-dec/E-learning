                            ...
                            <form action="{{ route('teacher.material.update', $material) }}" method="POST"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                                            name="title" value="{{ $material->title }}" placeholder="Masukkan Judul Materi">
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror" name="content" rows="5"
                                        placeholder="Masukkan Keterangan Materi">{{ $material->content}}</textarea>
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('title') is-invalid @enderror"
                                                name="link_video" value="{{ $material->link_video }}"
